                                ...
                                <div class="p-4">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @endif
                                    <form action="{{route('provinces.update', $province->id)}}" method="POST" data-parsley-validate novalidate >
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="sortname" name="name" parsley-trigger="change" required value="{{$province->name}}" class="form-control" id="emailAddress">
                                        </div>
                                    </div>
                                    </div>
