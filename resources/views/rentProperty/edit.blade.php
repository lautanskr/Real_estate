                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Rent Edit</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Rent Edit</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card-box">
                                ...
                                <div class="p-4">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @endif
                                    <form action="{{route('rentProperty.update', $rentProperty->id)}}" method="POST" data-parsley-validate novalidate enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select  parsley-trigger="change" id="property" name="Pro_type_id"  class="form-control" required>
                                                ...
                                                @if($pro->id==$rentProperty->RPRelation->PCRelation->id)
                                                    <option value="{{$pro->id}}" selected>{{$rentProperty->RPRelation->PCRelation->name}}</option>
                                                    @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="pro_cat_id" parsley-trigger="change" required class="form-control" id="category">
                                                ...
                                                @if($cat->id==$rentProperty->RPRelation->id)
                                                    <option value="{{$cat->id}}" selected>{{$rentProperty->RPRelation->name}}</option>
                                                    @else
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="price" parsley-trigger="change" required class="form-control" value="{{$rentProperty->price}}">
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country"  parsley-trigger="change" id="country"  class="form-control" required>
                                        <option value="">Choose Country</option>
                                                ...
                                                @if($rentProperty->MRRelation->DMbelongTo->PDRelation->PCbelongTo->id==$con->id)
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="province" parsley-trigger="change" required class="form-control" id="province">
                                        ...
                                        @if($rentProperty->MRRelation->DMbelongTo->PDRelation->id==$pro->id)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="district" parsley-trigger="change" required class="form-control" id="district">
                                            ...
                                            @if($rentProperty->MRRelation->DMbelongTo->id==$dis->id)
                            ...
                            <div class="form-group">
                                ...
                                <select name="mun_id" parsley-trigger="change" required class="form-control" id="municipality">
                                     @foreach($municipality as $mun)
                                              @if($rentProperty->MRRelation->id==$mun->id)
                                            <option value="{{$mun->id}}" selected>{{$rentProperty->MRRelation->m_name}}</option>
                                            @else
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="ward" type="number" parsley-trigger="change" required class="form-control" id="ward" value="{{$rentProperty->ward}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="street" parsley-trigger="change" required class="form-control" id="street" value="{{$rentProperty->street}}">   
                            </div>
                        </div>
                    </div>  
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="near_by" parsley-trigger="change" required class="form-control" id="near_by" value="{{$rentProperty->near_by}}">    
                        </div>
                        </div>
                    </div>
