                                ...
                                <div class="p-4">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @endif
                                    <form action="{{route('districts.store')}}" method="POST" data-parsley-validate novalidate >
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="pass1" type="text"  name="name" placeholder="Enter District " required class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
