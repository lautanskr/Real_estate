...
{{-- <script src="{{asset('backend/assets/js/pages/dashboard_2.init.js')}}"></script> --}}
 ...
 <script src="{{asset('backend/assets/libs/datatables/dataTables.fixedHeader.min.js')}}"></script>
 <script src="{{asset('backend/assets/libs/datatables/dataTables.scroller.min.js')}}"></script>
 <script src="{{asset('backend/assets/libs/datatables/dataTables.fixedColumns.min.html')}}"></script>
