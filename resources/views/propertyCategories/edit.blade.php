            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Property Category Edit</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                ...
                                <div class="p-4">
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @endif
                                    <form action="{{route('propertyCategories.update', $propertyCategory->id)}}" method="POST" data-parsley-validate novalidate >
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="pro_type_id" type="text" parsley-trigger="change"  class="form-control" required>
                                                        ...
                                                        @if($pro->id==$propertyCategory->PCRelation->id)
                                                            <option value="{{$pro->id}}" selected>{{$propertyCategory->PCRelation->name}}</option>
                                                            @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name"  type="text" parsley-trigger="change" value="{{$propertyCategory->name}}" class="form-control" required>
                                        </div>
                                    </div>
                                    </div>
