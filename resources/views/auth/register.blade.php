                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="name" id="email" name="name" required="" placeholder="Name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="password" required="" name="password_confirmation" id="password" placeholder="Confirm Password">
                                    </div>
