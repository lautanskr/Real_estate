...
<script src="{{asset('front-end/js/typed.min.js')}}"></script>
...
<script src="{{asset('front-end/js/lightcase.js')}}"></script>
...
<script src="{{asset('front-end/js/ajaxchimp.min.js')}}"></script>
<script src="{{asset('front-end/js/newsletter.js')}}"></script>
<script src="{{asset('front-end/js/jquery.form.js')}}"></script>
<script src="{{asset('front-end/js/jquery.validate.min.js')}}"></script>
<script src="{{asset('front-end/js/searched.js')}}"></script>
<script src="{{asset('front-end/js/forms-2.js')}}"></script>
<script src="{{asset('front-end/js/map-style2.js')}}"></script>
<script src="{{asset('front-end/js/range.js')}}"></script>
<script src="{{asset('front-end/js/color-switcher.js')}}"></script>
<script>
...
<script src="{{asset('front-end/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
<script src="{{asset('front-end/revolution/js/jquery.themepunch.revolution.min.js')}}"></script>
